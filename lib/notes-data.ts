...
export const notes: Note[] = [
    ...
    blocks: [
      { type: "heading", text: "how i work" },
      {
        ...
        items: [
          ...
          "hands up, feet set",
          "80::20 signal::noise",
          "never attribute to malice first",
          "cover the zone",
          ...
          "all works together for your good",
    ...
    blocks: [
      ...
      { type: "heading", text: "all-time" },
      {
        ...
        items: [
          ...
          "[adventure of a lifetime](music:adventure-of-a-lifetime) — coldplay",
          "[i want you back](music:i-want-you-back) — jackson 5",
          "[billie jean](music:billie-jean) — michael jackson",
        ],
      },
    ],
  },
    ...
    blocks: [
      ...
      { type: "heading", text: "recent favorites" },
      {
        ...
        items: [
          ...
          "[Shuggie Bain](https://www.goodreads.com/book/show/52741293-shuggie-bain) — douglas stuart",
  ...
  },
  {
    id: "god-of-arepo",
    emoji: "🪨",
    title: "the god of arepo",
    daysAgo: 0,
    preview: "temples are built for gods. knowing this, a farmer builds a small temple to see what kind of god turns up.",
    blocks: [
      {
        type: "paragraph",
        text: "a piece of writing i keep coming back to. i don't know who wrote it originally but it lives in me.",
      },
      { type: "heading", text: "—" },
      { type: "paragraph", text: "Temples are built for gods. Knowing this, a farmer builds a small temple to see what kind of god turns up." },
      { type: "paragraph", text: "Arepo built a temple in his field, a humble thing, some stones stacked up to make a cairn, and two days later a god moved in." },
      { type: "paragraph", text: "\"Hope you're a harvest god!\", Arepo said, and set up an altar and burnt two stalks of wheat. \"It'd be nice, you know.\" He looked down at the ash smeared on the stone, the rocks all laid askew, and coughed and scratched his head. \"I know it's not much,\" he said, his straw hat in his hands, \"but — I'll do what I can. It'd be nice to think there's a god looking after me.\"" },
      { type: "paragraph", text: "The next day he left a pair of figs, the day after that he spent ten minutes of his morning seated by the temple in prayer. On the third day, the god spoke up." },
      { type: "paragraph", text: "\"You should go to a temple in the city,\" the god said. Its voice was like rustling wheat, like squeaks of fieldmice running through the grass. \"A real temple. A good one. Get some real gods to bless you. I'm no one much myself, but I might be able to put in a good word?\" It plucked a leaf from a tree and sighed. \"I mean, not to be rude. I like this temple. It's cozy enough. The worship's been nice. But you can't honestly believe that any of this is going to bring you anything.\"" },
      { type: "paragraph", text: "\"This is more than I was expecting when I built it,\" Arepo said, laying down his scythe and lowering himself to the ground. \"Tell me, what sort of god are you anyway?\"" },
      { type: "paragraph", text: "\"I'm of the fallen leaves,\" it said, \"the worms that churn beneath the earth. The boundary of forest and of field. The first hint of frost before the first snow falls. The skin of an apple as it yields beneath your teeth. I am a god of a dozen different nothings, scraps that lead to rot, momentary glimpses. A change in the air, and then it's gone.\"" },
      { type: "paragraph", text: "The god heaved another sigh. \"There's no point in worship in that, not like War, or the Harvest, or the Storm. Save your prayers for the things beyond your control, good farmer. You're so tiny in the world. So vulnerable. Best to pray to a greater thing than me.\"" },
      { type: "paragraph", text: "Arepo plucked a stalk of wheat and flattened it between his teeth. \"I like this sort of worship fine,\" he said, \"so if you don't mind, I think I'll continue.\"" },
      { type: "paragraph", text: "\"Do what you will,\" said the god, and withdrew deeper into the stones, \"but don't say I never warned you otherwise.\"" },
      { type: "paragraph", text: "Arepo would say a prayer before the morning's work, and he and the god contemplated the trees in silence. Days passed like that, and weeks, and then the Storm rolled in, black and bold and blustering. It flooded Arepo's fields, shook the tiles from his roof, smote his olive tree and set it to cinder. The next day, Arepo and his sons walked among the wheat, salvaging what they could. The little temple had been strewn across the field, and so when the work was done for the day, Arepo gathered the stones and pieced them back together." },
      { type: "paragraph", text: "\"Useless work,\" the god whispered, but came creeping back inside the temple regardless. \"There wasn't a thing I could do to spare you this.\"" },
      { type: "paragraph", text: "\"We'll be fine,\" Arepo said. \"The storm's blown over. We'll rebuild. Don't have much of an offering for today,\" he said, and laid down some ruined wheat, \"but I think I'll shore up this thing's foundations tomorrow, how about that?\"" },
      { type: "paragraph", text: "The god rattled around in the temple and sighed. A year passed and then another. The temple had layered walls of stones, a roof of woven twigs. Arepo's neighbours chuckled as they passed it. Some of their children left fruit and flowers. And then the harvest failed, the gods withdrew their bounty. In Arepo's field the wheat sprouted thin and brittle. People wailed and tore their robes, slaughtered lambs and spilled their blood, looked upon the ground with haunted eyes and went to bed hungry. Arepo came and sat by the temple, the flowers wilted now, the fruit shriveled nubs, Arepo's ribs showing through his chest, his hands still shaking, and murmured out a prayer." },
      { type: "paragraph", text: "\"There is nothing here for you,\" said the god, huddling in the dark. \"There is nothing I can do. There is nothing to be done.\" It shriveled, and spat out its words. \"What is this temple but another burden to you?\"" },
      { type: "paragraph", text: "\"We —\" Arepo said, and his voice wavered. \"So it's a lean year,\" he said, \"we've gone through this before, we'll get through this again. So we're hungry,\" he said, \"we've still got each other, don't we? And a lot of people prayed to other gods, but it didn't protect them from this. No,\" he said, and shook his head, and laid down some shriveled weeds on the altar. \"No, I think I like our arrangement fine.\"" },
      { type: "paragraph", text: "\"There will come worse,\" said the god, from the hollows of the stone, \"and there will be nothing I can do to save you.\"" },
      { type: "paragraph", text: "The years passed. Arepo rested a wrinkled hand upon the temple of stone and some days spent an hour there, lost in contemplation with the god. And one fateful day, from across the wine-dark seas, came War." },
      { type: "paragraph", text: "Arepo came stumbling to his temple now, his hand pressed against his gut, anointing the holy site with his blood. Behind him, his wheat fields burned, and the bones burned black in them. He came crawling on his knees to a temple of hewn stone, and the god rushed out to meet him." },
      { type: "paragraph", text: "\"I could not save them,\" said the god, its voice a low wail. \"I am sorry. I am sorry. I am so sorry.\" The leaves fell burning from the trees, a soft slow rain of ash. \"I have done nothing! All these years, and I have done nothing for you!\"" },
      { type: "paragraph", text: "\"Shush,\" Arepo said, tasting his own blood, his vision blurring. He propped himself up against the temple, forehead pressed against the stone in prayer. \"Tell me,\" he mumbled, \"tell me again. What sort of god are you?\"" },
      { type: "paragraph", text: "\"I —\" said the god, and reached out, cradling Arepo's head, and closed its eyes and spoke." },
      { type: "paragraph", text: "\"I'm of the fallen leaves,\" it said, and conjured up the image of them, \"the worms that churn beneath the earth. The boundary of forest and of field. The first hint of frost before the first snow falls. The skin of an apple as it yields beneath your teeth.\" Arepo's lips parted in a smile." },
      { type: "paragraph", text: "\"I am the god of a dozen different nothings,\" it said, \"the petals in bloom that lead to rot, the momentary glimpses. A change in the air —\" its voice broke, and it wept, \"before it's gone.\"" },
      { type: "paragraph", text: "\"Beautiful,\" Arepo said, his blood staining the stones, seeping into the earth. \"All of them. They were all so beautiful.\"" },
      { type: "paragraph", text: "And as the fields burned and the smoke blotted out the sun, as men were trodden in the press and bloody War raged on, as the heavens let loose their wrath upon the earth, Arepo the sower lay down in his humble temple, his head sheltered by the stones, and returned home to his god." },
      { type: "heading", text: "—" },
      { type: "paragraph", text: "Sora found the temple with the bones within it, the roof falling in upon them." },
      { type: "paragraph", text: "\"Oh, poor god,\" she said, \"with no one to bury your last priest.\" Then she paused, because she was from far away. \"Or is this how the dead are honored here?\" The god roused from its contemplation." },
      { type: "paragraph", text: "\"His name was Arepo,\" it said, \"he was a sower.\"" },
      { type: "paragraph", text: "Sora startled a little because she had never before heard the voice of a god. \"How can I honor him?\" she asked." },
      { type: "paragraph", text: "\"Bury him,\" the god said, \"beneath my altar.\"" },
      { type: "paragraph", text: "\"All right,\" Sora said, and went to fetch her shovel." },
      { type: "paragraph", text: "\"Wait,\" the god said when she got back and began collecting the bones from among the broken twigs and fallen leaves. She laid them out on a roll of undyed wool, the only cloth she had. \"Wait,\" the god said, \"I cannot do anything for you. I am not a god of anything useful.\"" },
      { type: "paragraph", text: "Sora sat back on her heels and looked at the altar to listen to the god." },
      { type: "paragraph", text: "\"When the Storm came and destroyed his wheat, I could not save it,\" the god said, \"when the Harvest failed and he was hungry, I could not feed him. When the War came —\" the god's voice faltered. \"When the War came, I could not protect him. He came bleeding from the battle to die in my arms.\" Sora looked down again at the bones." },
      { type: "paragraph", text: "\"I think you are the god of something very useful,\" she said." },
      { type: "paragraph", text: "\"What?\" the god asked." },
      { type: "paragraph", text: "Sora carefully lifted the skull onto the cloth. \"You are the god of Arepo.\"" },
      { type: "heading", text: "—" },
      { type: "paragraph", text: "Generations passed. The village recovered from its tragedies — homes rebuilt, gardens re-planted, wounds healed. The old man who once lived on the hill and spoke to stone and rubble had long since been forgotten, but the temple stood in his name." },
      { type: "paragraph", text: "Most believed it to be empty, as the gods who resided there long ago had fallen silent. Yet, any who passed the decaying shrine felt an ache in their hearts, as though mourning for a lost friend." },
      { type: "paragraph", text: "The god sat in his peaceful home, staring out at the distant road. How long had it been? \"The world must be a cruel place, that even the useful gods have abandoned, if farms can flood, harvests can run barren, and homes can burn.\" he thought." },
      { type: "paragraph", text: "He had come to understand that humans are senseless creatures, who would pray to a god that cannot grant wishes or bless upon them good fortune. Who would maintain a temple and bring offerings with nothing in return. Who would share their company and meditate with such a fruitless deity. Who would bury a stranger without the hope for profit. What bizarre, futile kindness they had wasted on him. What wonderful, foolish, virtuous, hopeless creatures humans were." },
      { type: "paragraph", text: "So he painted the sunset with yellow leaves, enticed the worms to dance in the soil, flourished the boundary between forest and field with blossoms and berries, christened the air with a biting cold before winter came, ripened the apples with crisp, red freckles to break under sinking teeth, and a dozen other nothings, in memory of the man who once praised the god's work on his dying breath." },
      { type: "heading", text: "—" },
      { type: "paragraph", text: "\"Hello, God of Every Humble Beauty in the World!\" called a familiar voice." },
      { type: "paragraph", text: "The squinting corners of the god's eyes wept down onto curled lips. \"Arepo,\" he whispered, for his voice was hoarse from its hundred-year mutism." },
      { type: "paragraph", text: "\"I am the god of devotion, of small kindnesses, of unbreakable bonds. I am the god of selfless, unconditional love, of everlasting friendships, and trust.\" Arepo avowed, soothing the other with every word." },
      { type: "paragraph", text: "\"That's wonderful, Arepo,\" he responded between tears, \"I am so happy for you — such a powerful figure will certainly need a grand temple. Will you go to the city to gather more worshippers? You'll be adored by all.\"" },
      { type: "paragraph", text: "\"No,\" Arepo smiled." },
      { type: "paragraph", text: "\"Farther than that, to the capitol then? Thank you for visiting here before your departure.\"" },
      { type: "paragraph", text: "\"No, I will not go there either,\" Arepo shook his head and chuckled." },
      { type: "paragraph", text: "\"Farther still? What ambitious goals you must have. There is no doubt in my mind that you will succeed, though.\" the elder god continued." },
      { type: "paragraph", text: "\"Actually,\" interrupted Arepo, \"I'd like to stay here, if you'll have me.\"" },
      { type: "paragraph", text: "The other god was struck speechless. \"... Why would you want to live here?\"" },
      { type: "paragraph", text: "\"I am the god of unbreakable bonds and everlasting friendships. And you are the god of Arepo.\"" },
    ],
  },
  {
    id: "writing",
